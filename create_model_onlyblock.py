...
def make_initial(layers, conv_unit):
    layers += [nn.Conv2d(1, int(conv_unit), kernel_size=(3, 3), padding=(1, 1)),
...
class GANAS(nn.Module):
    def __init__(self, population, conv_unit):
        ...
        globals()["senet_layers{}".format(0)] = []
        globals()["densenet_layers{}".format(0)] = []
        globals()["skip_layers{}".format(0)] = []
        ...
        for i in range(1, len(population)):
            if int(population[i]) == 2:
                ...
                if population[i + 1] == 4:
                    del globals()["layers{}".format(self.idx)]
                ...
                globals()["densenet_layers{}".format(self.idx)] = densenet(
                    globals()["densenet_layers{}".format(self.idx)],
                    conv_unit[i], self.growth_rate)
                self.idx += 1
                save_last = size_last_unit
                size_last_unit = self.growth_rate + save_last
                globals()["senet_layers{}".format(self.idx)] = []
                globals()["densenet_layers{}".format(self.idx)] = []
                globals()["layers{}".format(self.idx)] = []
                globals()["skip_layers{}".format(self.idx)] = []
        ...
        if self.idx != 0:
            for i in range(len(self.cnt)):
                if self.cnt[i] == 1:
                    ...
                    print("densenet a", x.size())
                elif self.cnt[i] == 5:
                    print("SENet b", x.size())
